// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, unused_field, prefer_final_fields, unnecessary_null_comparison
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "ff590a5a4db85293f4cf216327f481482e956eca572e1d8b807a3e2338fdd0dc/stage",
                ...
                child: ZStack(
                  [
                    Positioned(
                      ...
                      right: 0.0,
                      child: VxBox(
                        child: rad.category.text.uppercase.white.make().p12(),
                      )
                          .height(40)
                          .black
                          .alignCenter
